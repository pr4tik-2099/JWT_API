...
builder.Services.AddDbContext<MedSpaceReportContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("MedSpaceConnectionString")));

builder.Services.AddScoped<IMedSpaceService, MedSpaceService>();
